Stable Diffusion web UI DirectML Neuro.

Сборка создана для упрощения запуска и использования Stable Diffusion web UI DirectML.
...
- Использование:
	...
	WebUI LowVRAM.bat			Режим низкого потребления памяти на видеокарте.
	WebUI NoFP16.bat			Работа в режиме полной точности (FP32), влияет на качество результата и может повлиять на скорость работы, нужно больше памяти.
	WebUI LowVRAM NoFP16.bat	Режим низкого потребления памяти на видеокарте и работа в режиме FP32.
