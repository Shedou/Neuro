...
set GIT=
set VENV_DIR=
set COMMANDLINE_ARGS=--precision full --no-half --use-cpu all --opt-sub-quad-attention --opt-split-attention --opt-split-attention-v1 --disable-nan-check --autolaunch
