...
Внимание! У видеокарт AMD искусственно отключены асинхронные вычисления видеокартам архитектуры GCN 1.0, на видеокартах архитектуры GCN 1.0 (HD7750, HD7770, HD7850, HD7870) возможны проблемы в работе приложений на основе Vulkan API, в том числе Rean ESRGAN NCNN Vulkan! 
