...
- Использование:
	...
	WebUI LowVRAM.bat			Режим низкого потребления памяти на видеокарте (для видеокарт с 2-3 ГБ памяти).
	WebUI NoFP16.bat			Запрет на работу с низкой точностью FP16, может увеличить потребление памяти, влияет на качество результата и может повлиять на скорость работы.
	WebUI LowVRAM NoFP16.bat	Режим низкого потребления памяти на видеокарте и запрет на низкую точность FP16.
