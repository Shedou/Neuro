...
set GIT=
set VENV_DIR=
set COMMANDLINE_ARGS=--no-half-vae --precision full --no-half --lowvram --opt-sub-quad-attention --opt-split-attention --opt-split-attention-v1 --disable-nan-check --always-batch-cond-uncond --sub-quad-q-chunk-size 256 --sub-quad-kv-chunk-size 256 --sub-quad-chunk-threshold 75
